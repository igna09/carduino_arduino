...
#include "nodes/MainCarduinoNode/executors/CarstatusExecutor/CarstatusExecutor.h"
#include "nodes/MainCarduinoNode/executors/AllMessageExecutor/AllMessageExecutor.h"
#include "nodes/MainCarduinoNode/executors/MediaControlCanExecutor/MediaControlCanExecutor.h"
#include "nodes/MainCarduinoNode/executors/MainNodeCanReadSettingExecutor/MainNodeCanReadSettingExecutor.h"
#include "nodes/MainCarduinoNode/executors/MainNodeCanEvent/MainNodeCanEvent.h"
#include "nodes/MainCarduinoNode/executors/HeartbeatExecutor/HeartbeatExecutor.h"
#include "nodes/MainCarduinoNode/executors/MainNodeCanLog/MainNodeCanLog.h"
#include "nodes/MainCarduinoNode/executors/MainCarduinoNodeSerialEvent/MainCarduinoNodeSerialEvent.h"
...
#define RADIO_POWER_MOSFET_PIN D0
