...
void setup(void) {
  ...
  klineCarduinoNode = new KlineCarduinoNode(KLINE_NODE_ADDRESS, 0, 1, 7, 2, "SSID_KLINE_C3", "pwd12345");
  #else
  klineCarduinoNode = new KlineCarduinoNode(KLINE_NODE_ADDRESS, RX, D1, D8, D2, "SSID_KLINE_CARDUINO_NODE", "pwd12345");
  #endif
}
