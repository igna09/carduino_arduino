...
inline const Category Category::WRITE_SETTING = Category(0x03, "WRITE_SETTING", Setting::getValues, nullptr, Setting::getValueByName, Setting::getValueById);
...
inline const Category Category::GET_SETTINGS = Category(0x07, "GET_SETTINGS", nullptr, nullptr);
