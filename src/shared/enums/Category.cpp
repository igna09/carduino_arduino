...
inline const Category Category::WRITE_SETTING = Category(0x03, "WRITE_SETTING", Setting::getValues, nullptr, Setting::getValueByName);
...
inline const Category Category::GET_SETTINGS = Category(0x07, "GET_SETTINGS", Setting::getValues, nullptr);
