...
class BoolCarstatusCanbusMessage : public CarstatusCanbusMessageTypedInterface, public CarstatusCanbusMessage<bool> {
    public:
        BoolCarstatusCanbusMessage(unsigned long id, uint8_t *payload, uint8_t payloadLength);
