...
class StringCarstatusCanbusMessage : public CarstatusCanbusMessageTypedInterface, public CarstatusCanbusMessage<String> {
    public:
        StringCarstatusCanbusMessage(unsigned long id, uint8_t *payload, uint8_t payloadLength);
