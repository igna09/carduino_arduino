...
<!DOCTYPE HTML><html lang="en"><head><meta name="viewport" content="width=device-width,initial-scale=1"><meta charset="UTF-8"><script type="text/javascript">let baseUrl,currentPath=(baseUrl=window.location.search.includes("NODE_ENV=development")?"http://localhost":window.location.protocol+"//"+window.location.host,document.write("<base href='"+baseUrl+"' />"),"/");function post(e,t,n){httpRequest("POST",e,t,n)}function get(e,t){httpRequest("GET",e,void 0,t)}function httpRequest(e,t,n,l){let o=new XMLHttpRequest;o.open(e,t),o.setRequestHeader("Content-Type","application/json"),o.setRequestHeader("Accept","application/json"),o.setRequestHeader("Access-Control-Allow-Origin","*"),o.onload=e=>{200<=o.status&&o.status<300?l(JSON.parse(o.response)):console.error(o.statusText,o.response)},n?o.send(JSON.stringify(n)):o.send()}function humanFileSize(e,t=!1,n=1){var l=t?1e3:1024;if(Math.abs(e)<l)return e+" B";var o=t?["kB","MB","GB","TB","PB","EB","ZB","YB"]:["KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"];let i=-1;for(var a=10**n;e/=l,++i,Math.round(Math.abs(e)*a)/a>=l&&i<o.length-1;);return e.toFixed(n)+" "+o[i]}function getAllFiles(e){post("/file-list",{path:currentPath=e},e=>{var t=document.getElementById("file-list");t.innerHTML="";let o=document.createElement("table");var n=o.insertRow(),l=n.insertCell(),i=n.insertCell(),n=n.insertCell();l.textContent="Name",n.textContent="Action",i.textContent="Size",e.forEach(e=>{var t=o.insertRow(),n=t.insertCell(),l=t.insertCell(),t=t.insertCell();n.textContent=e.name,l.textContent=humanFileSize(e.size),"file"===e.type?((n=document.createElement("button")).textContent="Download",n.addEventListener("click",()=>{window.open(""+currentPath+e.name)}),(l=document.createElement("button")).textContent="Delete",l.addEventListener("click",()=>{deleteFile(currentPath+e.name)}),t.appendChild(n),t.appendChild(l)):"folder"===e.type&&((n=document.createElement("button")).textContent="Open",n.addEventListener("click",()=>{getAllFiles(currentPath+e.name+"/")}),t.appendChild(n))}),t.appendChild(o),document.getElementById("home-button").disabled="/"===currentPath,document.getElementById("path-label").textContent=currentPath})}function goHome(){getAllFiles("/")}function deleteFile(e){post("/delete-file",{filename:e},e=>{getAllFiles(currentPath)})}getAllFiles("/")</script></head><body><p></p><h1>Files</h1><span id="path-label"></span> <button id="home-button" onclick="goHome()" disabled="disabled">Torna alla home</button><div id="file-list"></div><p></p><p></p><h1>File upload</h1><form method="POST" action="/file-upload" enctype="multipart/form-data"><span><input type="file" name="file" multiple="multiple"></span><input type="submit" name="upload" value="Upload" title="Upload File"></form><span>If you are seeing this page means that not every angular has been uploaded (favicon.ico.gz index.html.gz main.js.gz polyfills.js.gz styles.css.gz)</span><p></p></body></html>
)rawliteral";
