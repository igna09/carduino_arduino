...
#include "CarduinoNode/DoorCarduinoNode/executors/DoorNodeEvent/DoorNodeEvent.h"
#include "CarduinoNode/DoorCarduinoNode/executors/DoorNodeCarstatus/DoorNodeCarstatus.h"
...
#define DELAY_CLOSING_MIRROR_ON_POWER_EVENTS 0
#define DELAY_OPENING_MIRROR_ON_POWER_EVENTS 1500
