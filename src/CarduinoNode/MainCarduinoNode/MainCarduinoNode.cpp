...
void MainCarduinoNode::powerManagementPinsSetup() {
    ...
    pinMode(RADIO_POWER_MOSFET_PIN, OUTPUT);
    pinMode(ACCESSORY_12_V_PIN, INPUT);

    // if(i2cValid) {
    digitalWrite(RADIO_POWER_MOSFET_PIN, HIGH);
